...
const MobileFooter = () => {
  return (
    <footer className="bg-mango-600 text-white pt-8 pb-4 relative overflow-hidden">
      {/* Simple background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-mango-700 opacity-60"></div>
        <div className="absolute -right-20 -top-20 w-40 h-40 bg-mango-500 rounded-full blur-3xl opacity-20"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-xs text-mango-200">বাংলাদেশের সেরা আম সরবরাহকারী</p>
          </div>
        ...
        {/* Important contact info only */}
        <div className="mb-6">
          <ul className="space-y-2">
            <li className="flex items-center">
              <span className="bg-mango-500/30 p-1.5 rounded-lg mr-2 flex-shrink-0">
                <Phone className="w-3.5 h-3.5 text-mango-300" />
              </span>
              <span className="text-white/80 text-xs">+৮৮০ ১৭১২-৩৪৫৬৭৮</span>
            </li>
            <li className="flex items-center">
              <span className="bg-mango-500/30 p-1.5 rounded-lg mr-2 flex-shrink-0">
                <Mail className="w-3.5 h-3.5 text-mango-300" />
              </span>
              <span className="text-white/80 text-xs">info@amros.com.bd</span>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-6">
          <div className="relative">
            <input 
              ...
              className="w-full bg-white/10 py-2 px-3 rounded-lg text-xs focus:outline-none placeholder-white/50 pr-10"
              required
            />
            <Mail className="w-4 h-4 absolute right-3 top-1/2 transform -translate-y-1/2 text-mango-300/70" />
          </div>
        </div>
...
const Footer = () => {
  return (
    <>
      ...
      {/* Desktop footer */}
      <footer className="hidden md:block bg-mango-600 text-white pt-10 md:pt-16 pb-6 md:pb-8 relative overflow-hidden">
